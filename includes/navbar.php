    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mx-auto mb-2 mb-lg-0" id="spy-target">
        <li class="nav-item active">
          <a class="nav-link <?php if($active == "home")echo "active"?>" href="../index.php#home">Home</a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link <?php if($active == "menu")echo "online-order"?>" href="../index.php#online-order">Online Order</a>
        </li>
        <li class="nav-item">
